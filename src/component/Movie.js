...
class Movie extends Component {
    ...
    render() {
        ...
        return (
            <div className="Movie__Box" onMouseOver={this.handleMouseEnter} onClick={this.handleMovieSelect} onMouseLeave={this.props.store._isMovieSelected ? this.handleBgRestore : null}>
                <div className="Poster__Wrap">
                    <img src={postUrl + this.props.poster} alt={this.props.title}/>
                </div>
                <div className="Movie__Info">
                    <h4>{this.props.title}</h4>
                    <p><i className="fas fa-star"/>{this.props.vote_average}</p>
                </div>
            </div>
        );
    }
