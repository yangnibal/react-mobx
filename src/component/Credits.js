            ...
            return (
                <div className="Credit__List" key={castList.id}>
                    <div className="Profile__Photo">
                        {castList.profile_path == null ? <i class='fas fa-user'/> : <img src={'https://image.tmdb.org/t/p/w300' + castList.profile_path} alt={castList.name}/>}
                    </div>
            ...
            <div className="Credits">
                ...
                <div className="Credit__List__Wrap">
                    <div className="Credit__List">
                        <div className="Profile__Photo">
                            {this.props.store.director.path == null ? <i class="fas fa-user"/> : <img src={postUrl + this.props.store.director.path} alt={this.props.store.director.name}/>}
                        </div>
